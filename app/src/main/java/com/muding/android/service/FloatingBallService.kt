...
import com.muding.android.MainActivity
...
class FloatingBallService : Service(), LifecycleOwner, SavedStateRegistryOwner {
    ...
    companion object {
        ...
        const val ACTION_START_SCREENSHOT = "com.muding.android.action.START_SCREENSHOT"
        const val ACTION_REFRESH_FLOATING_BALL_APPEARANCE =
            "com.muding.android.action.REFRESH_FLOATING_BALL_APPEARANCE"
