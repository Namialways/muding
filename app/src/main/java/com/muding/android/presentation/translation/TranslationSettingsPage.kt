...
class TranslationSettingsViewModelFactory(
...
class SettingsBackedCloudTranslationVerifier(
...
@Composable
fun rememberTranslationSettingsViewModelFactory(): TranslationSettingsViewModelFactory {
    val context = LocalContext.current.applicationContext
    return remember(context) {
        TranslationSettingsViewModelFactory(
            settingsRepository = AppGraph.appSettingsRepository(context),
            localModelGateway = DefaultLocalTranslationModelGateway(AppGraph.localTranslationModelManager()),
            cloudVerifier = SettingsBackedCloudTranslationVerifier(
                translationEngine = AppGraph.cloudTranslationEngine(context)
            )
        )
    }
}
...
fun TranslationSettingsPage(
    ...
    val viewModel: TranslationSettingsViewModel = viewModel(
        factory = rememberTranslationSettingsViewModelFactory()
    )
