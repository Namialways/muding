...
class RegionCropActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (uriString.isNullOrBlank()) {
            Toast.makeText(this, "ÎÞ·¨¼ÓÔØ½ØÍ¼", Toast.LENGTH_SHORT).show()
            finish()
            return
        }
        ...
        try {
            ...
            Toast.makeText(this, "½ØÍ¼¼ÓÔØÊ§°Ü£º${e.message}", Toast.LENGTH_SHORT).show()
            finish()
            return
        }
    ...
    private fun cropAndContinue(cropRectInBitmap: Rect) {
        ...
        lifecycleScope.launch {
            try {
                ...
                Toast.makeText(this@RegionCropActivity, "ÇøÓò²Ã¼ôÊ§°Ü£º${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
    }
